  ...
  return (
    <>
      ...
      <div style={{ padding: "2rem" }}>
        ...
        <p>
          At <strong>HavenRent</strong>, we strive to provide a transparent and
          fair refund experience.
        </p>

        <h2>1. Cancellation by Guest</h2>
        <p>
          If you need to cancel a booking, the refund amount will depend on the
          host’s cancellation policy, which is visible at the time of booking.
        </p>

        <h2>2. Cancellation by Host</h2>
        <p>
          If a host cancels your booking, you will receive a full refund, and we
          will assist you in finding a similar accommodation.
        </p>
        ...
        <p style={{ marginTop: "2rem" }}>
          Thank you for trusting <strong>HavenRent</strong> — your next
